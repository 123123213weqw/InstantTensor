...
#include <siphon/queue.hpp>
#include <siphon/async_executor.hpp>
#include <siphon/dl_binding/cuda_binding.hpp>
#include <siphon/dl_binding/cufile_binding.hpp>
#include <siphon/dl_binding/nccl_binding.hpp>

namespace siphon {

using namespace siphon::cuda_binding;
using namespace siphon::cufile_binding;
using namespace siphon::nccl_binding;
...
inline bool _env_use_internal_memory_register(){
    static bool ret = get_env("SIPHON_USE_INTERNAL_MEMORY_REGISTER").value_or("0") == "1";
    return ret;
}

inline bool _env_cache_buffer(){
    static bool ret = get_env("SIPHON_CACHE_BUFFER").value_or("0") == "1";
    return ret;
}

inline bool _env_debug() {
    static bool ret = get_env("SIPHON_DEBUG").value_or("0") == "1";
    return ret;
}
